...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body dir="rtl">
        ...
        <td>חיפוש לפי שם:
            ...
            <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator9" controltovalidate="txtsearch"  ValidationGroup="search" errormessage="נא הזן שם לחיפוש " ForeColor="Red" ></asp:RequiredFieldValidator>
                            ...
                            <table align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator5" controltovalidate="txtLastName" errormessage="נא הזן שם משפחה" ForeColor="Red" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>שם הילד :
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator4" controltovalidate="txtFirstName" errormessage="נא הזן שם פרטי" ForeColor="Red" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>ת"ז :
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:ImageButton ID="ImageButton3" runat="server" Height="17px"
                                            ImageUrl="~/images/cal.jpg" OnClick="ImageButton3_Click" Width="21px"  CausesValidation="False"/>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtddl_Neighborhood" InitialValue="-- שכונה--" ErrorMessage="בחר שכונה"  ForeColor="Red" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:ImageButton ID="ImageButton4" runat="server" Height="17px"
                                            ImageUrl="~/images/cal.jpg" OnClick="ImageButton4_Click" Width="21px" CausesValidation="False" />
