                ...
                <tr>
                    <td>
                        <asp:DropDownList ID="DropDownList2" runat="server">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DropDownList2" InitialValue="-- קטגוריה--" ErrorMessage="בחר שדה " ForeColor="Red" />

                        <asp:DropDownList ID="DropDownList1" runat="server">
                            <asp:ListItem>-- קטגוריה--</asp:ListItem>
                            <asp:ListItem>גיל</asp:ListItem>
                            <asp:ListItem>שם פרטי</asp:ListItem>
                            <asp:ListItem>טלפון בבית</asp:ListItem>
                            <asp:ListItem>טלפון נייד</asp:ListItem>
                        </asp:DropDownList>

                           <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList1" InitialValue="-- קטגוריה--" ErrorMessage="בחר שדה " ForeColor="Red" />
