        ...
        <div>
            <table dir="rtl">
                <tr>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddl_ItemSearch" InitialValue="-- קטגוריה--" ErrorMessage="בחר שדה " ForeColor="Red" />
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddl_ItemSearch1" InitialValue="-- קטגוריה--" ErrorMessage="בחר שדה " ForeColor="Red" />
                    <asp:TextBox ID="txtSearchName" runat="server"></asp:TextBox>
                    <asp:Button ID="btnSearch_Click" runat="server" Text="חיפוש" OnClick="btnSearch_Click_Click" />

                     <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator4" controltovalidate="txtSearchName" errormessage="נא הזן ערך" ForeColor="Red" />
            <p>
                <asp:LinkButton ID="ExportToExcel" runat="server" Text="יצוא לאקסל" OnClick="ExportToExcelButton_Click" ForeColor="Red" CausesValidation="False"></asp:LinkButton>
